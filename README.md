# MonPlugin
Plugin pour Minecraft version 1.9 et plus. Rajoute une fleche indicant la direction de votre base (parametrable), possibilite de sauvegarder des waypoints ainsi que les coordonnees de votre mort la plus r√©cente...
...
- Affichage dans le chat du joueur les coordonn√©es du lieu de sa mort.
...
- revoir la facon d'acceder au commande pour le mettre √† jour et le simplifier...
...
- que les plugins "FallenKingdomZalles1-9.jar" et "ActionBarAPI-1.5.2.jar" soit prÈsent dans le dossier plugin.
